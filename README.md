...
<p align="center">
  <strong>Our paper has been accepted to IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI). 🎉</strong>
</p>
...
| **FLUX.1-dev** | 1024x1024 | RL-Best (Stage 2) | [flux-best.pkl](./exps/flux/flux-best.pkl) |
| | | Start (manual init) | [flux-start.pkl](./exps/flux/flux-start.pkl) |
